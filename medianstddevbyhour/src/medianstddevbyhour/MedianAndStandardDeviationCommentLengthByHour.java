package medianstddevbyhour;

import static medianstddevbyhour.MRDPUtils.DATE_FORMAT;
import static medianstddevbyhour.MRDPUtils.isNullOrEmpty;
import static medianstddevbyhour.MRDPUtils.transformXmlToMap;
...
import medianstddevbyhour.MedianStdDevTuple;
...
public class MedianAndStandardDeviationCommentLengthByHour extends Configured implements Tool {
	...
	public static class MedianStdDevReducer
			extends Reducer<IntWritable, SortedMapWritable, IntWritable, MedianStdDevTuple> {
